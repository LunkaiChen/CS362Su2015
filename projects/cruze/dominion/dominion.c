...
void adventurerEffect(int handPos, int currentPlayer, struct gameState *state) {
	int cardDrawn = 0;
	int drawntreasure = 0;
	int z = 0;
...
void villageEffect(int handPos, int currentPlayer, struct gameState *state) {
	//+1 Card
	drawCard(currentPlayer, state);
	drawCard(currentPlayer, state);
...
void outpostEffect(int handPos, int currentPlayer, struct gameState *state) {
	//set outpost flag
	state->outpostPlayed++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
		// Refactored
		adventurerEffect(handPos, currentPlayer, state);
		return 0;
