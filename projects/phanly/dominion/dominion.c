...
int cutpurseCardEffect(int currentPlayer, int handPos, struct gameState *state) {
    int i;
    int j;
    int k;
...
int greatHallCardEffect(int currentPlayer, int handPos, struct gameState *state) {
    ...
    int randomNumber = floor(Random() * 10);
...
int treasureMapCardEffect(int currentPlayer, int handPos, struct gameState *state) {
    int i;
