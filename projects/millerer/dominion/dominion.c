...
//below are my refactored card functions
...
int great_hall_card (int handPos,int currentPlayer, struct gameState *state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
    adventure_card(currentPlayer, state);
      return 0;
    ...
    case remodel:
    remodel_card (choice1, choice2, handPos, currentPlayer, state);
    return 0;
    ...
    case village:
    village_card(handPos, currentPlayer, state);
      return 0;
