...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
    	//function move out 1
    	Adventurer_Ref(currentPlayer, state);
    	return 0;

    case council_room:
      //+4 Cards
    	//function move out 2
      CouncilRoom_Ref(currentPlayer, handPos, state);
	  return 0;

    case feast:
      //gain card with cost up to 5
    	//function move out 3
      Feast_Ref(currentPlayer, choice1, state);
      return 0;
    ...
    case mine:
    	//function move out 4
    	Mine_Ref(currentPlayer, handPos, choice1, choice2, state);
    	return 0;
    ...
    case smithy:
      //+3 Cards
    	//function move out 5
      Smithy_Ref(handPos, currentPlayer, state);
      return 0;
...
//Case adventurer code refactored
...
//Case CouncilRoom code refactored
