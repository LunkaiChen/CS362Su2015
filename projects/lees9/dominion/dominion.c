...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      call_adventurer(currentPlayer, state);
      return 0;

    case council_room:
      call_council_room(currentPlayer, handPos, state);
      return 0;
    ...
    case smithy:
      call_smithy(currentPlayer, handPos, state);
      return 0;

    case village:
      call_village(currentPlayer, handPos, state);
      return 0;
    ...
    case great_hall:
      call_great_hall(currentPlayer, handPos, state);
      return 0;
