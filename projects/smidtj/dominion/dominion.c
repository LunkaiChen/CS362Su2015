...
//////////////////////
//Functions added by Jesse Smidt

int playSmithy(int player, struct gameState *state, int pos){
     //+3 Cards
     int i;
     for (i = 1; i < 3; i++)
     {
...
int playVillage(int player, struct gameState *state, int pos){
     //+1 Card
     drawCard(player, state);
...
int playGreat_hall(int player, struct gameState *state, int pos){
     //+1 Card
     drawCard(player, state);
...
int playAdventurer(int player, struct gameState *state){
     ...
     while (z - 1 >= 0){
          state->deck[player][state->deckCount[player]++] = temphand[z - 1]; // discard all cards in play that have been drawn
          z = z - 1;
     }
     return 0;
}

int playMinion(int player, struct gameState *state, int pos, int c1, int c2){
     int i, j;
     //+1 action
     state->numActions++;
     ...
     else if (c1)		//discard hand, redraw 4, other players with 5+ cards discard hand and draw 4
     {
          //discard hand
...
//End Functions added by Jesse Smidt
////////////////////////////
