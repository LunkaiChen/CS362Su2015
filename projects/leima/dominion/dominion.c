...
int adventurerAction(int drawntreasure, int currentPlayer, struct gameState *state);
int council_roomAction(int handPos, int currentPlayer, struct gameState *state);
int villageAction(int handPos, int currentPlayer, struct gameState *state);
int great_hallAction(int handPos, int currentPlayer, struct gameState *state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  if(card == smithy)
	  smithyAction(handPos, currentPlayer, state);

  else if(card == adventurer)
	  adventurerAction(drawntreasure, currentPlayer, state);

  else if(card == council_room)
	  council_roomAction(handPos, currentPlayer, state);

  else if(card == village)
	  villageAction(handPos, currentPlayer, state);

  else if(card == great_hall)
	  great_hallAction(handPos, currentPlayer, state);
