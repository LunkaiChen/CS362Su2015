...
/* **************************** seperate card functions ******************************************* */

	int _remodelCard(int choice1, int choice2, struct gameState *state, int handPos) {
      int i, j;
      int currentPlayer = whoseTurn(state);
	...
	int _smithyCard(int handPos, struct gameState *state) {
	...
	int _adventurerCard(struct gameState *state) {
	  int drawntreasure=0;
	  int currentPlayer = whoseTurn(state);
      int cardDrawn;
	...
	int _villageCard(struct gameState *state, int handPos) {
	  int currentPlayer = whoseTurn(state);
      //+1 Card
      drawCard(currentPlayer, state);
	...
	int _sea_hagCard(struct gameState *state){
    int currentPlayer = whoseTurn(state);
    int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  /*  -->>  modifed */
      ...
      for (i = 0; i < state->handCount[currentPlayer]; i++)
	{
     ...
     /*************/
    case remodel:
      _remodelCard(choice1, choice2, state, handPos);

     /*************/
    case smithy:
      _smithyCard(handPos, state);

     /*************/
    case village:
      _villageCard(state, handPos);
...
// end of card effect switch cases
