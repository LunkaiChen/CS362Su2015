...
The Adventurer card is an Action card. When played during the Action phase the cards will be drawn until two treasure cards are drawn. The treasure cards are added to the current players hand while all other drawn cards are discarded. When played a while loop will execute calling drawCard() adding the card to the current players hand. The while loop will continue to execute until two treasure cards are drawn. If the drawn card is a treasure a drawn treasure counter will be incremented. If the drawn card is not a treasure, it will be saved to a temporary location and not be added to the player's hand. After the two treasure cards have been drawn, all other drawn cards are discarded.
