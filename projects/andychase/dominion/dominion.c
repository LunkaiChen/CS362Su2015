...
void adventureCard(int currentPlayer, struct gameState *state) {
  int drawntreasure = 0;
  int z = 0;
  int cardDrawn;
...
void greatHallCard(int handPos, int currentPlayer, struct gameState *state) {
  //+1 Card
  drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
  ...
  switch (card) {
    case adventurer:
      adventureCard(currentPlayer, state);
      return 0;
