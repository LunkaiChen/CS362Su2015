...
void playSmithyCard(struct gameState *state, int currentPlayer, int handPos){
	 int i;
...
void playVillageCard(struct gameState *state, int currentPlayer, int handPos){
	 //+1 Card
	      drawCard(currentPlayer, state);
...
void playGreathallCard(struct gameState *state, int currentPlayer, int handPos){
	      //+1 Card
	      drawCard(currentPlayer, state);
...
int playRemodelCard(int choice1, int choice2, struct gameState *state, int currentPlayer, int handPos){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case remodel:
    	playRemodelCard(choice1, choice2, state, currentPlayer, handPos);
      return 0;
    ...
    case great_hall:
    	playGreathallCard(state, currentPlayer, handPos);
      return 0;
