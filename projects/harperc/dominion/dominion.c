...
void adventurer_played(struct gameState *state, int currentPlayer){
      int drawntreasure = 0;
      int cardDrawn;
      int temphand[4];
...
void smithy_played(struct gameState *state, int currentPlayer, int handPos){
      //+3 Cards
      int i;
      for (i = 0; i < 4; i++)
	{
...
void council_room_played(struct gameState *state, int currentPlayer, int handPos ){
      //+4 Cards
      int i;
      for (i = 0; i < 4; i++)
	{
...
void village_played(struct gameState *state, int currentPlayer, int handPos ){
      //+1 Card
      drawCard(currentPlayer, state);
...
void great_hall_played(struct gameState *state, int currentPlayer, int handPos ){
      //+1 Card
      drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurer_played(state, currentPlayer);
      return 0;
			
    case council_room:
      council_room_played(state, currentPlayer, handPos);		
      return 0;
    ...
    case great_hall:
      great_hall_played(state, currentPlayer, handPos);
      return 0;
