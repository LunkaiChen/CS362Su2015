...
int executemine(int handPos, int currentPlayer, struct gameState *state, int choice1, int choice2)
{
	int i, j;
...
int executesmithy(int handPos, int currentPlayer, struct gameState *state)
{
	int i;
	//+3 Cards
	      for (i = 0; i <= 3; i++)
		{
	      ...
	      //discard card from hand
	      discardCard(handPos -1 , currentPlayer, state, 1);
	return 0;
}

int executesteward(int choice1, int choice2, int choice3, int handPos, int currentPlayer, struct gameState *state)
{
	if (choice1 == 1)
		{
		  //+2 cards
...
int executevillage(int handPos, int currentPlayer, struct gameState *state)
{
	   //+1 Card
	      drawCard(state->numPlayers -1, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
      return executemine(handPos, currentPlayer, state, choice1, choice2);
    ...
    case smithy:
      return executesmithy(handPos, currentPlayer, state);
		
    case village:
      return executevillage(handPos, currentPlayer, state);
    ...
    case steward:
      return executesteward(choice1, choice2, choice3, handPos, currentPlayer, state);
