...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    switch( card )
    {
        ...
        case embargo: 
            return embargoCardEffect(currentPlayer, state, HandPos);
...
/* function copied from cardEffect() section then edited */
...
/* function copied from cardEffect() section with no edits*/
