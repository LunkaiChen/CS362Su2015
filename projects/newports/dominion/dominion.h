...
/* separate function added for adventurer card */

int smithyCardEffect(int currentPlayer, struct gameState *state, int handPos);
/* separate function added for smithy card */

int villageCardEffect(int currentPlayer, struct gameState *state, int handPos);
/* separate function added for village card */

int councilroomCardEffect(int currentPlayer, struct gameState *state, int handPos);
/* separate function added for council room card */

int embargoCardEffect(int currentPlayer, struct gameState *state, int HandPos);
/* separate function added for embargo card */
