...
int playMine(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2, int treasure_map, int curse)
{
      int j;
      int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
      playMine(currentPlayer, state, handPos, choice1, choice2, treasure_map, curse);
      return 0;
