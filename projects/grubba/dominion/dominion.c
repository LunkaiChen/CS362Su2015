...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      playAdventurer(currentPlayer, drawntreasure, state, z, temphand);
      return 0;
    ...
    case mine:
			playMine(currentPlayer, handPos, state, choice1, choice2);
      return 0;
    ...
    case cutpurse:
      playCutpurse(currentPlayer, handPos, state);
      return 0;
