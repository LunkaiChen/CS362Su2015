...
// takes game state, current player number, hand position
// plays smithy card
...
// takes game state, current player, choice1
// plays feast card
int cardFeast(struct gameState *state, int currentPlayer, int choice1){
      int i, x;
      int temphand[MAX_HAND];   // temporary hand
